/** Clinical Cartography: supporting management routes preserve the same ledger-like clarity and disclose when their owning live service is not configured. */
import { Building2, FileBarChart, Hospital, KeyRound, Settings2, ShieldCheck, UsersRound } from "lucide-react";
...
const config = {
  facilities: { icon: Hospital, eyebrow: "Management / Facilities", title: "Facility directory", subtitle: "Network nodes monitored through the active operations context." },
  vendors: { icon: UsersRound, eyebrow: "Management / Vendors", title: "Vendor directory", subtitle: "Qualified supplier records used by procurement and supply orders." },
  reports: { icon: FileBarChart, eyebrow: "Management / Reports", title: "Operational reports", subtitle: "Exportable control views for availability, consumption, and supply movement." },
  audit: { icon: ShieldCheck, eyebrow: "System / Audit", title: "Audit register", subtitle: "Traceable operational events retained for review and compliance." },
  settings: { icon: Settings2, eyebrow: "System / Settings", title: "Workspace settings", subtitle: "Identity context and service connection configuration for this DIStrack client." },
} as const;
