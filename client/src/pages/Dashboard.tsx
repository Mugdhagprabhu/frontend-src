  ...
  return (
    <div ref={containerRef} className="page-enter max-w-[1640px] text-white">
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(330px,.65fr)]">
        <article className="section-panel surface-panel p-5 sm:p-6 border border-[#223c47] bg-[#13242b]">
          <SectionHeading 
          ...
          />
          <div className="mt-5 h-[270px] sm:h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data.consumptionTrend} margin={{ top: 8, right: 8, left: -20, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="forecast" stroke="#9bb3c1" strokeWidth={1.5} strokeDasharray="4 4" fill="none" name="Baseline" animationDuration={1100} animationEasing="ease-out" />
                <Area type="monotone" dataKey="observed" stroke="#00f0a0" strokeWidth={2.4} fill="url(#observedFill)" name="Observed" animationDuration={1400} animationEasing="ease-out" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2 border-t border-[#223c47] pt-3 text-[11px] font-medium text-[#cbd5e1]">
